...
(ns ^{:no-doc true} edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.edn
  ...
  (:require [edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.reader-types :refer
            ...
            [edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.impl.utils :refer
            ...
            [edamame.impl.toolsreader.v1v3v2.clojure.tools.reader :refer [default-data-readers]])
...
(defn read
  "Reads the first object from an IPushbackReader or a java.io.PushbackReader.
   ...
   edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.edn/read doesn't depend on dynamic Vars, all configuration
...
(defn read-string
  "Reads one object from the string s.
   ...
   opts is a map as per edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.edn/read"
