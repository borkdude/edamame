...
(ns ^{:no-doc true} edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.reader-types
  (:refer-clojure :exclude [char read-line])
  (:require [edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.impl.utils :refer [char whitespace? newline? make-var]])
...
(extend-protocol ReaderCoercer
  ...
  edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.reader_types.Reader
  (to-rdr [rdr] rdr)
  String
...
(extend-protocol PushbackReaderCoercer
  ...
  edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.reader_types.PushbackReader
  (to-pbr [rdr buf-len] (push-back-reader rdr buf-len))
  String
...
(defn indexing-reader?
  ...
  [rdr]
  (or (instance? edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.reader_types.IndexingReader rdr)
      (instance? LineNumberingPushbackReader rdr)
      (and (not (instance? edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.reader_types.PushbackReader rdr))
           (not (instance? edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.reader_types.StringReader rdr))
           (not (instance? edamame.impl.toolsreader.v1v3v2.clojure.tools.reader.reader_types.InputStreamReader rdr))
